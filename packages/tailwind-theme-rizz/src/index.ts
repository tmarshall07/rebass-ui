...
const transparentSharedSlateClasses = [
  'hover:bg-slate-100',
  'active:bg-slate-200',
  'text-slate-600',
  'dark:text-slate-300',
...
const transparentSharedBlueClasses = [
  'hover:bg-blue-100',
  'active:bg-blue-200',
  'text-blue-600',
  'dark:text-blue-300',
...
export const theme = {
  button: {
    default: {
      colors: {
        blue: [...baseSharedClasses, 'bg-blue-500 hover:bg-blue-700 active:bg-blue-800', 'text-white'],
        slate: [...baseSharedClasses, 'bg-slate-500 hover:bg-slate-700 active:bg-slate-800', 'text-white'],
      }
    },
    transparent: {
      colors: {
